(function ( $, x5engine ) {
	...
	s.siteId = 'C0B9BBA5167D978183C08C3A3305D772';
	s.islocal = true;
	s.version = '13-0-1-16';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'U', path: 'captcha/imcpa_8tm.gif'},
				"1": { letter: 'V', path: 'captcha/imcpa_wl5.gif'},
				"2": { letter: '3', path: 'captcha/imcpa_l52.gif'},
				"3": { letter: 'R', path: 'captcha/imcpa_am5.gif'},
				"4": { letter: '5', path: 'captcha/imcpa_lf2.gif'},
				"5": { letter: 'L', path: 'captcha/imcpa_wy8.gif'},
				"6": { letter: '8', path: 'captcha/imcpa_e43.gif'},
				"7": { letter: 'F', path: 'captcha/imcpa_7gk.gif'},
				"8": { letter: 'X', path: 'captcha/imcpa_han.gif'},
				"9": { letter: 'F', path: 'captcha/imcpa_3s8.gif'}
			}
		});
	}, false, 'first');
